package com.obushko.cryptowallet.Activities.Domain;
...
public class CryptoWallet {
    ...
    public CryptoWallet(String cryptoName, String cryptoSymbol, Double cryptoPrice,
                        Double changePercent, ArrayList<Integer> lineData,
                        Double propertyAmount, Double propertySize) {
